...
def get_parsed_path():
    """
    This argument parser captures the input from stdin, and
    validates the input text file path.
    """
    parser = argparse.ArgumentParser(
        prog="write-tight",
        description="This program validates whether your input text file exists.",
    )
    parser.add_argument("path", type=path_exists, help="path to your text file.")
